function Hero() {
    return (
        <section 
            id="home" 
            className="hero relative text-white flex min-h-svh bg-[url(/images/hero-image.webp)] bg-center bg-cover bg-no-repeat bg-scroll lg:bg-fixed lg:ml-80 lg:w-[calc(100%-320px)] lg:[background-position-x:300px] bg-black/30 bg-blend-darken">
