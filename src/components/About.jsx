function About() {
    return (
        <section id="about" className="flex relative w-[calc(100%-320px)] ml-80 bg-[#151515]">
            <div className="flex mx-auto items-center gap-10 py-24">
                ...
                <div className="description max-w-lg flex flex-col gap-7 text-white text-lg">
                    <div className="box-icon bg-white w-fit text-black p-1 rounded-md hover:-translate-y-1 duration-300 ease-in-out">
