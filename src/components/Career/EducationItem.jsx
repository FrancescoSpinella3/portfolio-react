function EducationItem({ degree, place, dates, site }) {
    return (
        <div className="education flex flex-col items-start gap-5 pt-7 pb-7 border-t border-zinc-800 last:pb-0 lg:flex-row lg:justify-between lg:gap-12 xl:gap-48 light:border-zinc-400">
