function ExperienceItem({ work, place, dates, site }) {
    return (
        <div className="experience flex flex-col items-start gap-5 pt-7 pb-7 border-t border-zinc-800 last:pb-0 lg:flex-row lg:justify-between lg:gap-12 xl:gap-48">
